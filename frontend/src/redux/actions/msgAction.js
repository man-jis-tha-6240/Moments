...
export const addMessage = ({ msg, auth, socket }) => async (dispatch) => {
	...
	const { _id, avatar, yourName, userName } = auth.user
	socket.emit('addMessage', { ...msg, user: { _id, avatar, yourName, userName } })
	try {
...
export const deleteMsg = ({ msg, data, auth }) => async (dispatch) => {
...
export const deleteConvo = ({ auth, id }) => async (dispatch) => {
